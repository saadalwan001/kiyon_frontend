  ...
  return (
    <div className="w-full">
      ...
      <section className=" mb-[80px]">
        ...
        <h2 className=" text-lg md:text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl font-['Playfair_Display']">
            Our Vision
        </h2>
        
        <p className="max-w-3xl mx-auto text-gray-500 mb-12 mt-12 font-['barlow']">
      ...
      </p> <h2 className="text-lg md:text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl font-['Playfair_Display'] ">
            Our Mission
        </h2>
