    ...
    <footer className="bg-[#303030] text-white pt-[80px]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="flex items-center justify-center">
          <button className="border border-white text-white px-6 py-3 rounded-lg font-bold hover:bg-[#238B45] transition font-['Playfair_Display']">
            Check Availability
          </button>
        </div>
        ...
        <div className="flex flex-col space-y-3 font-['barlow'] font-bold">
          ...
          <a href="tel:+94711234567" className="flex items-center gap-2 hover:text-[#238B45] transition-colors">
            <Phone size={18} />
            <span>+94 71 123 4567</span>
          </a>
          <a href="mailto:info@kiyontravels.com" className="flex items-center gap-2 hover:text-[#238B45] transition-colors">
            <Mail size={18} />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div className="flex flex-col space-y-4">
          <h2 className="text-lg font-bold font-['Playfair_Display']">Subscribe To Stay Updated</h2>
        ...
        <div className="flex flex-col items-start md:items-end space-y-4">
          <div className="flex gap-4">
            <a
              href="#"
              className="w-10 h-10 flex items-center justify-center border border-white rounded-full text-white transition-all duration-300 hover:bg-[#238B45] hover:border-[#238B45] hover:text-white"
            >
              <Facebook size={24} />
            </a>
            <a
          ...
          <p className="text-sm text-white font-['barlow'] font-bold">
