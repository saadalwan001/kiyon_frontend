...
const AboutUs = () => {
  ...
  {/* This is Us Section */}
<section className="max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-12 mb-[80px]">
  ...
  <div className="flex flex-col justify-between h-full">
    ...
    <p className="text-xl text-gray-700 leading-relaxed font-['barlow'] text-justify">
      ...
      <section className=" mb-[80px]">
        ...
        <h2 className=" text-5xl md:text-3xl lg:text-2xl xl:text-4xl 2xl:text-5xl font-['Playfair_Display']">
            Our Vision
        </h2>
      ...
      </p> <h2 className=" text-5xl  md:text-3xl lg:text-2xl xl:text-4xl 2xl:text-5xl font-['Playfair_Display'] ">
            Our Mission
        </h2>
  ...
  >
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="grid lg:grid-cols-2 gap-10 items-center">
        ...
        {/* Left column */}
        <div>
          <h2 className="text-6xl font-bold text-white md:text-7xl text-center font-['Playfair_Display']">
            What We Offer
          </h2>
        </div>
